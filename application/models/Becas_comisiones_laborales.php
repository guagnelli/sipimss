...
class Becas_comisiones_laborales extends CI_Model {
    ...
    public function get_lista_becas($empleado_cve = null) {
    ...
    public function get_lista_comisiones($empleado_cve = null) {
        if (isset($empleado_cve) AND is_null($empleado_cve)) {
            return -1;
        }
        $select = array('eaid.EAID_CVE "cve_investigacion"', 'eaid.EIAE_NOMBRE_INV "nombre_investigacion"'
