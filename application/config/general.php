...
$config['estados_val_censo'] = array(
    Enum_ev::Inicio => array('value' => 'Inicio', 'rol_permite' =>array(Enum_rols::Docente), 'estados_transicion' => array(), 'value_boton' => '', 'funcion_demandada' => '', 'value_boton' => '', 'tipo_transaccion'=>'', 'color_status' => '', 'cambiar_estado_revision' => false, 'estado_anterior_verificar'=>''),
    Enum_ev::Incompleta => array('value' => 'Incompleta', 'rol_permite' =>array(Enum_rols::Docente), 'estados_transicion' => array(), 'value_boton' => '', 'tipo_transaccion'=>'', 'color_status' => '', 'cambiar_estado_revision' => false, 'estado_anterior_verificar'=>''), 
    Enum_ev::Completa => array('value' => 'Completa', 'rol_permite' => array(Enum_rols::Docente), 'estados_transicion' => array(Enum_ev::Por_validar_n1), 'value_boton' => 'Enviar a validación', 'funcion_demandada' => '', 'tipo_transaccion'=>'', 'color_status' => 'NO_VALIDO', 'cambiar_estado_revision' => false, 'estado_anterior_verificar'=>''), 
    Enum_ev::Por_validar_n1 => array('value' => 'Por validar N1', 'rol_permite' =>array(Enum_rols::Validador_N1),'estados_transicion' => array(Enum_ev::En_revision_n1), 'value_boton' => 'Enviar a revisión nivel 1', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'', 'color_status' => 'REVISION', 'cambiar_estado_revision' => true, 'estado_anterior_verificar'=>''),
    Enum_ev::En_revision_n1 => array('value' => 'En revisión N1', 'rol_permite' =>array(Enum_rols::Validador_N1),'estados_transicion' => array(Enum_ev::Correccion_docente, Enum_ev::Val_n1_por_validar_n2), 'value_boton' => 'Enviar a revisión nivel 1', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)' ,'is_boton' => FALSE, 'tipo_transaccion'=>'revisión', 'color_status' => 'REVISION', 'cambiar_estado_revision' => false, 'est_apr_para_validacion'=>array(Enum_ev::Por_validar_n1, Enum_ev::En_revision_n1, Enum_ev::Correccion_n1), 'estado_anterior_verificar'=>''),
    ...
    Enum_ev::Validado => array('value' => 'Validado profesionalización', 'rol_permite' =>array(),'estados_transicion' => array(), 'value_boton' => 'Validar', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'validación', 'color_status' => 'VALIDO', 'cambiar_estado_revision' => false, 'estado_anterior_verificar'=>''),
);
/**
...
$config['estados_val_evaluacion'] = array(
    ...
    Enum_evec::Envio_solicitud_evaluacion => array('rol_permite' => array(Enum_rols::Docente), 'estados_transicion' => array(Enum_evec::Por_validar_n1), 'value_boton' => 'Enviar a validación', 'funcion_demandada' => '', 'tipo_transaccion'=>'solicitud de evaluación', 'color_status' => 'NO_VALIDO'), 
