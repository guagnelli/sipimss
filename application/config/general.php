...
$config['TABLAS'] = array(
    'COMISION_ACADEMICA' => array('tabla_censo'=>'emp_comision', 'tabla_validacion'=>'hist_comision_validacion_curso', 'campo'=>'EMP_COMISION_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'FORMACION_SALUD' => array('tabla_censo'=>'emp_for_personal_continua_salud', 'tabla_validacion'=>'hist_fpcs_validacion_curso', 'campo'=>'FPCS_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'INVESTIGACION_SALUD' => array('tabla_censo'=>'emp_desa_inv_salud', 'tabla_validacion'=>'hist_edis_validacion_curso', 'campo'=>'EDIS_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'INVESTIGACION_EDUCATIVA' => array('tabla_censo'=>'emp_act_inv_edu', 'tabla_validacion'=>'hist_eaid_validacion_curso', 'campo'=>'EAID_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'BECA' => array('tabla_censo'=>'emp_beca', 'tabla_validacion'=>'hist_beca_validacion_curso', 'campo'=>'EMP_BECA_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'FORMACION_PROFESIONAL' => array('tabla_censo'=>'emp_formacion_profesional', 'tabla_validacion'=>'hist_efp_validacion_curso', 'campo'=>'EMP_FORMACION_PROFESIONAL_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'MATERIAL_EDUCATIVO' => array('tabla_censo'=>'emp_materia_educativo', 'tabla_validacion'=>'hist_me_validacion_curso', 'campo'=>'MATERIA_EDUCATIVO_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'EDUCACION_DISTANCIA' => array('tabla_censo'=>'emp_educacion_distancia', 'tabla_validacion'=>'hist_edd_validacion_curso', 'campo'=>'EMP_EDU_DISTANCIA_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'ESPECIALIDAD_MEDICA' => array('tabla_censo'=>'emp_esp_medica', 'tabla_validacion'=>'hist_eem_validacion_curso', 'campo'=>'EMP_ESP_MEDICA_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
    'ACTIVIDAD_DOCENTE' => array('tabla_censo'=>'emp_actividad_docente', 'tabla_validacion'=>'hist_efpd_validacion_curso', 'campo'=>'EMP_ACT_DOCENTE_CVE', 'campo_empleado' => 'EMPLEADO_CVE', 'campo_hist' => 'VAL_ESTADO_CVE'),
);
...
$config['estados_val_evaluacion'] = array(
    ...
    Enum_evec::Envio_solicitud_evaluacion => array('rol_permite' => array(Enum_rols::Docente), 'estados_transicion' => array(Enum_evec::Por_validar_n1), 'value_boton' => 'Enviar a validación', 'funcion_demandada' => '', 'tipo_transaccion'=>'', 'color_status' => 'NO_VALIDO'), 
    Enum_evec::Por_validar_n1 => array('rol_permite' =>array(Enum_rols::Validador_N1),'estados_transicion' => array(Enum_evec::En_revision_n1), 'value_boton' => 'Enviar a revisión nivel 1', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'', 'color_status' => 'REVISION'),
    Enum_evec::En_revision_n1 => array('rol_permite' =>array(Enum_rols::Validador_N1),'estados_transicion' => array(Enum_evec::Correccion_docente, Enum_evec::Val_n1_por_validar_n2), 'value_boton' => 'Enviar a revisión nivel 1', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)' ,'is_boton' => FALSE, 'tipo_transaccion'=>'revisión', 'color_status' => 'REVISION', 'est_apr_para_validacion'=>array(Enum_evec::Por_validar_n1, Enum_evec::En_revision_n1, Enum_evec::Correccion_n1)),
    Enum_evec::Correccion_docente => array('rol_permite' =>  array(Enum_rols::Docente),'estados_transicion' => array(Enum_evec::Por_validar_n1), 'value_boton' => 'Enviar a corrección por docente', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'corrección', 'color_status' => 'CORRECCION'),
    Enum_evec::Val_n1_por_validar_n2 => array('rol_permite' =>array(Enum_rols::Validador_N2),'estados_transicion' => array(Enum_evec::En_revision_n2), 'value_boton' => 'Enviar a validar por nivel 2', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)','is_boton' => TRUE, 'tipo_transaccion'=>'validación', 'color_status' => 'VALIDO'),
    ...
    Enum_evec::Correccion_n1 => array('rol_permite' =>array(Enum_rols::Validador_N1),'estados_transicion' => array(Enum_evec::Correccion_docente, Enum_evec::Val_n1_por_validar_n2), 'value_boton' => 'Enviar a corrección por nivel 1', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'corrección', 'color_status' => 'CORRECCION', 'est_apr_para_validacion'=>array(Enum_evec::Por_validar_n1, Enum_evec::En_revision_n1, Enum_evec::Correccion_n1)),
    Enum_evec::Val_n2_por_validar_profesionalizacion => array('rol_permite' =>array(Enum_rols::Profesionalizacion),'estados_transicion' => array(Enum_evec::En_revision_profesionalizacion), 'value_boton' => 'Enviar a validar por profesionalización', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'validación', 'color_status' => 'VALIDO'),
    Enum_evec::En_revision_profesionalizacion => array('rol_permite' =>array(Enum_rols::Profesionalizacion),'estados_transicion' => array(Enum_evec::Correccion_n2, Enum_evec::Validado_prof_por_validar_GAECUD), 'value_boton' => 'Enviar a revisión profesionalización', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => FALSE, 'tipo_transaccion'=>'revisión', 'color_status' => 'REVISION', 'est_apr_para_validacion'=>array(Enum_evec::Val_n2_por_validar_profesionalizacion, Enum_evec::En_revision_profesionalizacion)),
    Enum_evec::Correccion_n2 => array('rol_permite' =>array(Enum_rols::Validador_N2),'estados_transicion' => array(Enum_evec::Correccion_n1, Enum_evec::Val_n2_por_validar_profesionalizacion), 'value_boton' => 'Enviar a corrección por nivel 2', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'corrección', 'color_status' => 'CORRECCION', 'est_apr_para_validacion'=>array(Enum_evec::Val_n1_por_validar_n2, Enum_evec::En_revision_n2, Enum_evec::Correccion_n2)),
    Enum_evec::Validado_prof_por_validar_GAECUD => array('rol_permite' =>array(),'estados_transicion' => array(), 'value_boton' => 'Validar', 'funcion_demandada' => 'envio_cambio_estado_validacion(this)', 'is_boton' => TRUE, 'tipo_transaccion'=>'validación', 'color_status' => 'VALIDO'),
);
