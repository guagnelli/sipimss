	...
	$(function() {
	    ...
	    if($('#btn_convocatoria_enviar').length){
	        $('#btn_convocatoria_enviar').on('click', function() {
	            data_ajax(site_url+'/convocatoria_evaluacion/agregar_convocatoria/'+$(this).attr('data-value'), '#formularioConvocatoria', '#capa_html');
	        });
	    }
	});
	</script>
