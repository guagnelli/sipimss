          ...
          <div id="collapseThree<?php echo $id?>" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
            <div class="box-body  table-responsive no-padding">
              <table class="table table-hover">
                <tbody>
                <tr>
                  <th style="width: 10%"><?php echo $string_value['seleccionar']; ?></th>
                  <th style="width: 50%"><?php echo $string_value['curso']; ?></th>
                  <th style="width: 40%"><?php echo $string_value['tipo_curso']; ?></th>
                </tr>
                <?php
