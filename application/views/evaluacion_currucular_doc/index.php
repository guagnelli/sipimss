...
//                            pr($value_mod);
                    ...
                    $data_bloque['estado_validacion_bloque'] = $estado_validacion_bloque[$key_bloque];
                    if ($mostrar_boton_val) {
                        echo $this->load->view('evaluacion_currucular_doc/tablas_seccion_docente/result_tpl', $data_bloque, true);
                    }
                    ?>
                </div>
            </div>
