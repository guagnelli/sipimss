        ...
        <div class="list-group-item">
                <div class="panel-body">
                            ...
                            <div class='row'>
                                ...
                                <div class="col-md-6">
                                    <label for='lbl_especialidad' class="control-label">
                                        <b class="rojo">*</b>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php 
                                            echo $this->form_complete->create_element(array('id' => 'ctipo_especialidad', 'type' => 'dropdown', 
                                                ...
                                                'value' => (isset($ctipo_especialidad_cve))? $ctipo_especialidad_cve : '',
                                                'attributes' => array('name' => 'ctipo_especialidad_name', 'class' => 'form-control', 
                                                'placeholder' => $string_values['lbl_especialidad'], 
                                                'data-toggle' => 'tooltip', 
                                                'data-placement' => 'top', 
                                                'title' => $string_values['lbl_especialidad'] ))); 
                                        ?>
                                   </div>
