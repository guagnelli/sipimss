    ...
    <table class="table table-striped table-hover table-bordered" id="tabla_investigacion_docente">
        <thead>
            <tr class="bg-info">
                ...
                <th ><?php echo $string_values['titulo_delegacion'] ?></th>
                <th ><?php echo $string_values['titulo_departamento_adscripcion'] ?></th>
...
//                $hist_val_cve = $this->seguridad->encrypt_base64(intval($val['hist_validacion_cve']));
                ...
                $link_ver_detalle = '<button '
                            ...
                            . 'data-idrow ="' . $key_ai . '"'
                            . 'data-valgrl="' . $val_grl_cve . '"'
                            . 'data-docente="' . $empleado_cve . '"'
                            . 'data-toggle="modal"'
                            . 'data-target="#modal_censo"'
                            . 'onclick="ver_detalle_validado(this)" >' .
