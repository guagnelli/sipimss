...
$lang['interface'] = array(
    ...
    'perfil' => array(
        ...
        'plh_informacion_general_matricula' => 'Introduzca su matrícula',
        'lbl_informacion_general_delegacion' => 'Delegación',
        'plh_informacion_general_delegacion' => 'Introduzca su delegacion',
        'lbl_informacion_general_nombre_categoria' => 'Nombre de la categoría/Puesto',
        'plh_informacion_general_nombre_categoria' => 'Introduzca el nombre de la categoría/Puesto',        
        'lbl_informacion_general_clave_categoria' => 'Clave de la categoría/Puesto',
        'plh_informacion_general_clave_categoria' => 'Introduzca la clave de la categoría/Puesto',
        'lbl_informacion_general_nombre_area_adscripcion' => 'Nombre del área de adscripción',
        'plh_informacion_general_nombre_area_adscripcion' => 'Introduzca el nombre del área de adscripción',
        'lbl_informacion_general_nombre_unidad_adscripcion' => 'Nombre de la unidad de adscripción',
        'plh_informacion_general_nombre_unidad_adscripcion' => 'Introduzca el nombre de la unidad de adscripción',
        'lbl_informacion_general_nombre_clave_adscripcion' => 'Clave de adscripción',
        'plh_informacion_general_nombre_clave_adscripcion' => 'Introduzca la clave de adscripción',
        ...
        'plh_informacion_general_tipo_contratacion' => 'Introduzca el tipo de contratación',
        'lbl_informacion_general_estatus_empleado' => 'Estatus del empleado',
        'plh_informacion_general_estatus_empleado' => 'Introduzca el estatus del empleado',
        'lbl_informacion_general_clave_presupuestal' => 'Clave presupuestal',
        'plh_informacion_general_clave_presupuestal' => 'Introduzca la clave presupuestal',
        'lbl_informacion_general_curp' => 'Curp',
        'plh_informacion_general_curp' => 'Introduzca su CURP',      
    ),
);
