...
//        data_ajax(site_url + '/validacion_censo_profesores/get_data_ajax_actividad/', '#form_actividad_docente', '#get_data_ajax_actividad');
        apprise('Confirme que realmente desea actualizar los datos', {verify: true}, function (btnClick) {
            if (btnClick) {
                $.ajax({
                    url: site_url + '/validacion_censo_profesores/seccion_actividad_docente',
...
//    alert(act_general_cve + ' ' + entidad_tp_a_cve + ' ' + act_docente_cve + ' ' + cp);
    ...
    $.ajax({
        url: site_url + '/validacion_censo_profesores/get_data_ajax_actualiza_curso_principal',
        data: {
...
function function_carga_form_actividad_doc() {
    ...
    data_ajax_post(site_url + '/validacion_censo_profesores/get_vista_form_act_docente', null, '#info_actividad_docente', data_post);
